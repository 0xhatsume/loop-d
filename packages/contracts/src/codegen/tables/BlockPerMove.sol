...
bytes32 constant _tableId = bytes32(abi.encodePacked(bytes16(""), bytes16("BlockPerMove")));
bytes32 constant BlockPerMoveTableId = _tableId;

library BlockPerMove {
  ...
  function getMetadata() internal pure returns (string memory, string[] memory) {
    ...
    _fieldNames[0] = "value";
    return ("BlockPerMove", _fieldNames);
  }
