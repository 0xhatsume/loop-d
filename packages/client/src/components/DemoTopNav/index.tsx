...
import { demoPauseAtom } from '../../store';

export const DemoTopNav = () => {
    const gameSpeedref = useRef(null);
    // const {
    ...
    return (
        ...
        >
            ...
            font-medival font-extrabold text-3xl 
            text-start
            ml-7 text-[#BBBCBC]
            ">
                { pause ? 'GAME PAUSED' : 'BATTLE!'}
            </div>
        ...
        >
                ...
                rounded-3xl ${ pause ? 'border-2 border-red-500': 
